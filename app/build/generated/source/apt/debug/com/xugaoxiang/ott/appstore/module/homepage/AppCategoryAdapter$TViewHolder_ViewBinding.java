...
public class AppCategoryAdapter$TViewHolder_ViewBinding<T extends AppCategoryAdapter.TViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public AppCategoryAdapter$TViewHolder_ViewBinding(T target, View source) {
    this.target = target;
