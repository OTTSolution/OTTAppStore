 ...
 */
package com.xugaoxiang.ott.appstore.util.log;
...
public class LogReader extends Thread {
    ...
    public static final String LOG_FILE_PATH = "AppStoreLog.txt";
    public static final String LOG_ROOT_PATH = Environment.getExternalStorageDirectory() + File.separator;
