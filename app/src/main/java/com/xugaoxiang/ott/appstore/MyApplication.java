...
import com.xugaoxiang.ott.appstore.util.FileUtils;
...
/**
 * Created by zero on 2016/9/23.
 */
public class MyApplication extends LitePalApplication {

    public static boolean isSlient = true;
    ...
    private void initAppServer() {
        String appServer = FileUtils.readFile(Constants.FILE_APPSERVER);
        if (!TextUtils.isEmpty(appServer))
        {
            Constants.BASE_URL = appServer;
            Log.i("成功修改本地请求地址：" + Constants.BASE_URL);
        }
    }
